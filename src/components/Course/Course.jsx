...
const Course = ({ course, handelAddToDetails }) => {
    ...
    return (
        <div className='bg-[#FFF] p-3 rounded-xl' >
            ...
            <h1 className='text-lg font-semibold my-2'>{course_name}</h1>
            <p className='text-sm font-normal text-[#6a6969] my-2'>{title}</p>
            <div className='flex justify-between'>
                <div className='flex gap-1 items-center'>
                    ...
                    <p className='text-sm font-medium'><span></span> Price:{price}</p>
